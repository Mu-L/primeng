...
Report it privately through [GitHub's private vulnerability reporting](https://github.com/primefaces/primeng/security/advisories/new), or email **security@primetek.com.tr** if you'd rather not use GitHub.
